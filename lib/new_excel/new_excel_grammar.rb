...
class NewExcelGrammarParser < Racc::Parser

module_eval(<<'...end new_excel_grammar.y/module_eval...', 'new_excel_grammar.y', 65)
...
...end new_excel_grammar.y/module_eval...
...
module_eval(<<'.,.,', 'new_excel_grammar.y', 5)
...
module_eval(<<'.,.,', 'new_excel_grammar.y', 18)
...
module_eval(<<'.,.,', 'new_excel_grammar.y', 21)
...
module_eval(<<'.,.,', 'new_excel_grammar.y', 22)
...
module_eval(<<'.,.,', 'new_excel_grammar.y', 39)
...
end   # class NewExcelGrammarParser
